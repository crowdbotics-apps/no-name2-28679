"""no_name2_28679 URL Configuration
...
admin.site.site_header = "no name2"
admin.site.site_title = "no name2 Admin Portal"
admin.site.index_title = "no name2 Admin"

# swagger
api_info = openapi.Info(
    title="no name2 API",
    default_version="v1",
    description="API documentation for no name2 App",
)
